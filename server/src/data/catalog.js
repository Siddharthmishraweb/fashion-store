...
export const PHOTOS = {
  ...
  artisan: img('photo-1727430228383-aa1fb59db8bf', 1400),
  ...
  look7: img('photo-1727430228383-aa1fb59db8bf'),
  look8: img('photo-1509631179647-0177331693ae'),
  look9: img('photo-1581044777550-4cfa60707c03'),
  look10: img('photo-1487222477894-8943e31ef7b2'),
  look11: img('photo-1496747611176-843222e1e57c'),
  look12: img('photo-1595777457583-95e059d581b8'),
  weave: img('photo-1727430228383-aa1fb59db8bf', 800),
  ...
  insta6: img('photo-1727430228383-aa1fb59db8bf', 600),
}
...
export const STORE_BLUEPRINTS = [
  ...
  },
  {
    ...
    city: 'Varanasi',
    announcement: 'Search festive sarees · Complimentary blouse stitching on weaves above ₹9,999',
  },
  {
    id: 'store_nivaa',
    slug: 'nivaa-studio',
