    ...
    return {
      ...
      sections: [
        ...
        },
        {
          ...
          type: 'category_grid',
          enabled: true,
          config: { title: 'Shop By Look', style: 'looks' },
        },
        {
          id: 'sec_fav',
          type: 'product_slider',
          enabled: true,
          config: { title: 'Customer favourites', collectionId: `col_${store.id}_best`, showPrice: true },
        },
        {
          id: 'sec_weave',
          type: 'shop_by_fabric',
          enabled: true,
          config: { title: 'Shop by weave' },
        },
        {
          id: 'sec_craft',
          type: 'shop_by_region',
          enabled: true,
          config: { title: 'Shop by craft cluster' },
        },
        {
          id: 'sec_promo',
